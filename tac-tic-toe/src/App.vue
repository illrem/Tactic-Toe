...
<div class="container">
  ...
  <div v-bind:class="{hidden:!puzzles || puzzleSelected || userPuzzle}">  
    ...
    <button @click="loadPuzzle('22')">Puzzle 25</button>
    <button @click="loadPuzzle('23')">Puzzle 26</button>
    <button @click="loadPuzzle('24')">Puzzle 27</button>
    <br> <br>
...
export default {
  ...
  loadPuzzle(puzzleNum){
    ...
    else if (puzzleNum == '3'){this.puzzleMoves = 3; this.puzzleMovesRemaining = 3; movelog = [[3,5],[5,3],[3,4],[4,7],[7,7],[7,1],[1,4],[4,1],[1,8],[8,1],[1,0],[0,3],[3,3],[3,8],[8,3],[3,7],[7,0],[0,4],[4,4],[4,2],[2,8],[8,4],[4,0],[0,5],[5,5],[5,0],[0,6],[6,4],[4,8],[8,7],[7,3],[3,6],[6,8],[8,8],[8,0],[0,8],[8,6],[6,6],[6,2],[2,1],[1,5],[5,6],[6,5]];}
    else if (puzzleNum == '4'){this.puzzleMoves = 3; this.puzzleMovesRemaining = 3; movelog = [[1,3],[3,3],[3,5],[5,4],[4,4],[4,8],[8,6],[6,6],[6,5],[5,5],[5,3],[3,0],[0,6],[6,8],[8,8],[8,7],[7,3],[3,6],[6,4],[4,7],[7,4],[4,6],[6,3],[3,2],[2,8],[8,4],[4,5],[5,0],[0,3],[3,1],[1,7],[7,5],[5,8],[8,1],[1,4],[4,3],[3,8],[8,5],[5,2],[2,4],[4,2],[2,7],[7,2],[2,1],[1,5],[5,7],[7,6],[6,0],[0,0],[0,5],[5,1],[1,2],[2,2],[2,5],[5,6    ]];}
    else if (puzzleNum == '5'){this.puzzleMoves = 5; this.puzzleMovesRemaining = 5; movelog = [[2,2],[2,4],[4,7],[7,3],[3,6],[6,3],[3,3],[3,0],[0,5],[5,8],[8,4],[4,4],[4,5],[5,4],[4,6],[6,4],[4,8],[8,5],[5,0],[0,7],[7,7],[7,4],[4,3],[3,1],[1,7],[7,5],[5,3],[3,2],[2,0],[0,6],[6,5],[5,6],[6,8],[8,8],[8,2],[2,1],[1,1],[1,4],[4,2],[2,7],[7,8],[8,6],[6,2],[2,3],[3,8],[8,7],[7,6],[6,6],[6,1]];}
    ...
    else if (puzzleNum == '8'){this.puzzleMoves = 4; this.puzzleMovesRemaining = 4; movelog = [[1,6],[6,5],[5,6],[6,6],[6,4],[4,5],[5,0],[0,7],[7,8],[8,1],[1,7],[7,7],[7,5],[5,3],[3,7],[7,2],[2,5],[5,4],[4,3],[3,4],[4,0],[0,4],[4,6],[6,3],[3,8],[8,4],[4,8],[8,7],[7,4],[4,7],[7,3]];}
    else if (puzzleNum == '9'){this.puzzleMoves = 3; this.puzzleMovesRemaining = 3; movelog = [[3,3],[3,8],[8,5],[5,8],[8,8],[8,2],[2,6],[6,3],[3,0],[0,5],[5,5],[5,4],[4,7],[7,7],[7,8],[8,0],[0,3],[3,6],[6,1],[1,3],[3,7],[7,4],[4,4],[4,1],[1,8],[8,4],[4,2],[2,8],[8,1],[1,7],[7,1],[1,1],[1,4],[4,6],[6,2],[2,5],[5,0],[0,8],[8,6],[6,0],[0,2],[2,2],[2,7],[7,3],[3,1],[1,6],[6,6],[6,4],[4,8],[8,7],[7,2],[2,0],[0,0],[0,6],[6,5],[5,7],[7,5],[5,1],[1,0],[0,7],[7,6],[6,8]];}
    else if (puzzleNum == '10'){this.puzzleMoves = 4; this.puzzleMovesRemaining = 4; movelog = [[3,4],[4,8],[8,3],[3,6],[6,7],[7,0],[0,3],[3,7],[7,6],[6,5],[5,1],[1,8],[8,0],[0,2],[2,3],[3,8],[8,6],[6,4],[4,6],[6,6],[6,0],[0,5],[5,0],[0,8],[8,7],[7,1],[1,4],[4,5],[5,2],[2,1],[1,2],[2,4],[4,3],[3,2]];}
    else if (puzzleNum == '11'){this.puzzleMoves = 5; this.puzzleMovesRemaining = 5; movelog = [[4,7],[7,8],[8,5],[5,6],[6,3],[3,7],[7,7],[7,5],[5,8],[8,8],[8,4],[4,4],[4,8],[8,3],[3,3],[3,4],[4,6],[6,7],[7,4],[4,5],[5,5],[5,3],[3,0],[0,5]];}
    else if (puzzleNum == '12'){this.puzzleMoves = 4; this.puzzleMovesRemaining = 4; movelog = [[4,3],[3,7],[7,3],[3,1],[1,8],[8,3],[3,4],[4,8],[8,1],[1,6],[6,0],[0,3],[3,3],[3,5],[5,2],[2,6],[6,3],[3,2],[2,7],[7,8],[8,4],[4,7],[7,6],[6,6],[6,4],[4,6],[6,5],[5,5],[5,1],[1,3],[3,8],[8,7],[7,0],[0,6],[6,8],[8,2],[2,4],[4,0],[0,0],[0,7],[7,2],[2,1],[1,4],[4,5],[5,0],[0,8],[8,0],[0,5],[5,8],[8,8],[8,6],[6,2]];}
    else if (puzzleNum == '13'){this.puzzleMoves = 4; this.puzzleMovesRemaining = 4; movelog = [[7,1],[1,8],[8,6],[6,3],[3,1],[1,4],[4,8],[8,3],[3,4],[4,5],[5,4],[4,4],[4,3],[3,7],[7,7],[7,4],[4,7],[7,3],[3,8],[8,0],[0,5],[5,2],[2,6],[6,1],[1,0],[0,8],[8,4],[4,6],[6,4],[4,2],[2,3],[3,0],[0,7],[7,5],[5,8],[8,2],[2,0],[0,4],[4,1],[1,1],[1,7],[7,8],[8,8],[8,7],[7,6],[6,0],[0,0],[0,6],[6,6],[6,2],[2,1],[1,5],[5,0],[0,2]];}
    ...
    else if (puzzleNum == '15'){this.puzzleMoves = 5; this.puzzleMovesRemaining = 5; movelog = [[3,2],[2,7],[7,6],[6,1],[1,3],[3,6],[6,5],[5,4],[4,5],[5,2],[2,8],[8,2],[2,5],[5,6],[6,8],[8,4],[4,4],[4,3],[3,5],[5,1],[1,4],[4,6],[6,2],[2,2],[2,4],[4,0],[0,8],[8,6],[6,0],[0,4],[4,2],[2,0]];}
    ...
    else if (puzzleNum == '20'){this.puzzleMoves = 3; this.puzzleMovesRemaining = 3; movelog = [[7,6],[6,3],[3,5],[5,0],[0,8],[8,6],[6,2],[2,6],[6,4],[4,7],[7,4],[4,4],[4,1],[1,6],[6,6],[6,5],[5,8],[8,4],[4,2],[2,2],[2,4],[4,0],[0,4],[4,8],[8,2],[2,8],[8,7],[7,2],[2,0],[0,0],[0,6],[6,0],[0,7],[7,5],[5,6],[6,8],[8,8],[8,5],[5,7],[7,8],[8,3],[3,1],[1,2],[2,5],[5,3],[3,7],[7,3],[3,4],[4,6],[6,1],[1,4],[4,3],[3,3],[3,8],[8,0],[0,1],[1,8],[8,1],[1,0],[0,2],[2,7],[7,0],[0,3],[3,2],[2,3],[3,6],[6,7],[7,1],[1,5],[5,2],[2,1],[1,3],[3,0]];}
