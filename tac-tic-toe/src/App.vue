...
<div class="container">
  ...
  <div v-bind:class="{hidden:!puzzles || puzzleSelected || userPuzzle}">  
    ...
    <button @click="loadPuzzle('2')">Puzzle 2</button>
    <button @click="loadPuzzle('3')">Puzzle 3</button>
    <button @click="loadPuzzle('4')">Puzzle 4</button>
    <button @click="loadPuzzle('5')">Puzzle 5</button>
    <button @click="loadPuzzle('6')">Puzzle 6</button>
    <br> <br>
